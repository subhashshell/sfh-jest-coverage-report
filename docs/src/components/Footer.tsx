        ...
        <Container paddingY="6" maxWidth="container.lg">
            <Grid templateColumns={['1fr', null, 'repeat(4, 1fr)']}>
                ...
                <FooterSection heading="Repository">
                    <FooterLink
                        href="https://www.github.com/ArtiomTr/sfh-jest-coverage-report"
                        label="GitHub"
                    />
                    <FooterLink
                        href="https://www.github.com/ArtiomTr/sfh-jest-coverage-report/issues"
                        label="Issues"
                    />
                    <FooterLink
                        href="https://www.github.com/ArtiomTr/sfh-jest-coverage-report/releases"
                        label="Releases"
                    />
                    <FooterLink
                        href="https://github.com/sede-x/sfh-react/sfh-jest-coverage-report/stargazers"
                        label="Stars"
                    />
                </FooterSection>

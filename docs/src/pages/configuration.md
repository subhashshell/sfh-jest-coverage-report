...
**⚠ IMPORTANT: The test script must generate output in a specific format. For more information, see [docs](https://github.com/sede-x/sfh-react/sfh-jest-coverage-report#customizing-test-script).**
